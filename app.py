...
def board_commentary_yearly(
    ...
    # --- Principal risks / board questions / actions
    risks: List[str] = []
    questions: List[str] = []
    actions: List[str] = []
    ...
    if not risks:
        risks = ["Tidak ada red flag besar yang terdeteksi dari aturan dasar; tetap pantau konsistensi tren dan kelengkapan data."]
...
with st.expander("📌 Board-Level Risk Commentary (Lengkap)", expanded=False):
    ...
    st.markdown("#### Principal risks (yang perlu diwaspadai Board)")
