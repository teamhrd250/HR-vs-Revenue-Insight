...
# =========================
# HEADER (Logo + Title) — Board-grade layout
# =========================
...
with col_title:
    st.markdown(
        ...
        <div style="padding-top:6px;">
            <h2 style="margin:0;">HR vs Revenue Dashboard</h2>
            <div style="color:#9aa0a6; font-size:14px; margin-top:2px;">
