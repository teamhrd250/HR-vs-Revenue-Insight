    ...
    st.markdown(
        ...
        <div style="text-align:right; padding-top:6px;">
          <span style="
            ...
            background: rgba(255,255,255,0.04);
            font-size:12px;">
            <span style="width:10px; height:10px; border-radius:999px; background:{badge.get('color', '#7f8c8d')}; display:inline-block;"></span>
            <span style="opacity:0.9;"><b>Decision:</b> {badge['state']}</span>
            <span style="opacity:0.65;">({badge.get('confidence', 'High')})</span>
          </span>
        </div>
        """,
        unsafe_allow_html=True,
