...
# =========================
# HEADER (Logo + Title) — Board-grade layout (improved)
# =========================
...
def _render_header(logo_path: str) -> None:
    """Header premium: logo lebih jelas + container halus + hierarki judul rapih."""
    col_logo, col_title = st.columns([1.35, 6])

    with col_logo:
        if logo_path:
            # Render via HTML (base64) supaya bisa diberi container & styling yang konsisten.
            ...
            st.markdown(
                ...
                ">
                    <img src="data:{mime};base64,{b64}" style="width: 170px; height: auto; display:block;" />
                </div>
                """,
    ...
    with col_title:
        st.markdown(
            ...
            <div style="padding-top:10px;">
                <h1 style="margin:0; font-size:42px; line-height:1.05;">HR vs Revenue Dashboard</h1>
                <div style="color:#9aa0a6; font-size:14px; margin-top:6px;">
